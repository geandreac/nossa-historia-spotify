...
// O SEU WRAPPED (Retrospectiva da História de Vocês)
export const wrappedData = [
  {
    id: 1,
    title: "Se a nossa história fosse uma playlist...",
    highlight: "Ela seria a minha favorita.",
    subtitle: "Tudo começou em 1º de junho de 2024 com Planeta dos Macacos.",
    image: "/foto1.jpg", // Adicione fotos numeradas na pasta public se quiser, ou deixe o link do unsplash para testar
    bgColor: "from-emerald-600 to-teal-900",
  },
  {
    id: 2,
    title: "Tudo aconteceu bem rápido...",
    highlight: "Mas foi tão certo.",
    subtitle: "Da conexão na igreja ao nosso jantar no dia dos namorados, você logo virou parte da minha família.",
    image: null, // Slide focado apenas no texto gigante
    bgColor: "from-pink-600 to-rose-900",
  },
  {
    id: 3,
    title: "Você esperou 3 meses, até que no dia...",
    highlight: "11 de Setembro",
    subtitle: "Eu te pedi em namoro. E desde então, não nos desgrudamos mais.",
    image: "/foto2.jpg", 
    bgColor: "from-indigo-600 to-blue-900",
  },
  {
    id: 4,
    title: "E não foi só um mar de rosas...",
    highlight: "Nós escolhemos ficar.",
    subtitle: "Tivemos brigas? Muitas KKKKKKKK. Mas aprendemos que o amor é melhorar um pelo outro. Desistir nunca foi uma opção.",
    image: null,
    bgColor: "from-purple-600 to-fuchsia-900",
  },
  {
    id: 5,
    title: "Das viagens de 25/26 para a vida toda...",
    highlight: "Agradeço a Deus por você.",
    subtitle: "Obrigado por comemorar minhas vitórias e ser meu grande amor. Te amo!",
    image: "/foto3.jpg",
    bgColor: "from-orange-500 to-red-800",
  }
];